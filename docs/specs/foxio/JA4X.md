...
`tests/foxio_deviations.json` holds 120 entries, and **nine of them name this method.** The
table states each one as explained or unexplained by the specification.
