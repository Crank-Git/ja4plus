...
> **`tests/dependency_entries.py` is the one reader of a dependency block, and #452 built
...
> dependency block through that module and never through a second reader.** Two readers of
