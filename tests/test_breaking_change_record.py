...
**This file is the one guard that takes a round record from a member.** #727 moved the
round mandate to the batch pull request on 2026-08-15, so a member records no round of its
